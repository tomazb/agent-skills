...
- Ships with reference checklists for dependency patterns, data consistency, debuggability, load/concurrency, network/latency, observability, change management, disaster recovery, security/abuse resilience, quota exhaustion, complexity tax, severity calibration, and validation/monitoring patterns
