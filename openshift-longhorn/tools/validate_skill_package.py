...
EXPECTED_NAME = "openshift-longhorn"
FENCE_RE = re.compile(r"^\s*```")
FRONTMATTER_RE = re.compile(r"\A---\n(?P<body>.*?)\n---\n", re.DOTALL)

EXPECTED_REFERENCES = [
    "references/install-and-preflight.md",
    "references/v1-filesystem.md",
    "references/v2-block-data-engine.md",
    "references/migration-v1-v2.md",
...
UPGRADE_PHRASES = [
    "Do not downgrade",
    "Do not skip",
    "V2 Data Engine volumes are detached",
    "system backup",
]
