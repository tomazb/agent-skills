...
When preparing version-pinned example manifests that use placeholders, prefer the
packaged helper and pass explicit Rook/Ceph versions from live discovery (do not
treat helper defaults as the install target):
